...
public class TupleDesc implements Serializable {
    ...
    public TupleDesc(Type[] typeAr, String[] fieldAr) {
        ...
        if (fieldAr != null && fieldAr.length != typeAr.length) {
            throw new IllegalArgumentException("fieldAr and typeAr must have the same length");
        }

        items = new ArrayList<>(typeAr.length);
        for (int i = 0; i < typeAr.length; i++) {
            String fieldName = fieldAr == null ? null : fieldAr[i];
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        Type[] types = new Type[mergedLength];
        String[] names = new String[mergedLength];
    ...
    public String toString() {
        ...
        for (int i = 0; i < numFields(); i++) {
            ...
            builder.append(getFieldType(i)).append("(").append(getFieldName(i)).append(")");
        }
